...
const showCaseSlider = (props) => {
    return (
        <CarouselProvider
            ...
            naturalSlideHeight={111}
            totalSlides={3}>
            <Slider style={{ textAlign: "center" }}>
                <Slide
                    className={slideImg}
                    index={0}><img src={props.slideImageA} alt="slider 1" />
                </Slide>
                <Slide className={slideImg} index={1}><img src={props.slideImageB} alt="slider 2" /></Slide>
                <Slide className={slideImg} index={2}><img src={props.slideImageC} alt="slider 3" /></Slide>
            </Slider>
